"""YoutubeSentimentAnalysis.py

Original file is located at
    https://colab.research.google.com/drive/1Ai2t-BWDBqdOH-mpKBebzRtgR3RzuM5D
"""
...
#CONVERTING THE DATA IN BINARY FORM USING VECTORIZER
...
with open('C:\\code\\project\\vectorizer_LR.pkl', 'wb') as file:
    pickle.dump(vectoriser, file)

#TRAINING OUR MODEL(LOGICAL REGRESSION TYPE)
...
#naive baeys random forest google scholars